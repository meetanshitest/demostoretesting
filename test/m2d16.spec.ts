...
import { m2d16_Assertions } from "../pages/Assertions/m2d16_Assertions";
import axios from "axios";
import path from "path";

const DEFAULT_WEB_URL = "http://default-url.com";
const WEB_URL = process.env.WEB_URL?.split(",")[15] || DEFAULT_WEB_URL;
...
test.describe("m2d16 E-commerce Test Suite", () => {
  let m2d16: m2d16_Assertions;

  test.beforeEach(async ({ page }) => {
    m2d16 = new m2d16_Assertions(page);
  });
