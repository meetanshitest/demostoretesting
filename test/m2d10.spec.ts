...
import { m2d10_Assertions } from "../pages/Assertions/m2d10_Assertions";
import axios from "axios";
import path from "path";

const DEFAULT_WEB_URL = "http://default-url.com";
const WEB_URL = process.env.WEB_URL?.split(",")[9] || DEFAULT_WEB_URL;
...
test.describe("m2d10 E-commerce Test Suite", () => {
  let m2d10: m2d10_Assertions;

  test.beforeEach(async ({ page }) => {
    m2d10 = new m2d10_Assertions(page);
  });
