...
import { m2d20_Assertions } from "../pages/Assertions/m2d20_Assertions";
import axios from "axios";
import path from "path";

const DEFAULT_WEB_URL = "http://default-url.com";
const WEB_URL = process.env.WEB_URL?.split(",")[19] || DEFAULT_WEB_URL;
...
test.describe("m2d20 E-commerce Test Suite", () => {
  let m2d20: m2d20_Assertions;

  test.beforeEach(async ({ page }) => {
    m2d20 = new m2d20_Assertions(page);
  });
