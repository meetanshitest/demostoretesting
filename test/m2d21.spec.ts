...
import { m2d21_Assertions } from "../pages/Assertions/m2d21_Assertions";
import axios from "axios";
import path from "path";

const DEFAULT_WEB_URL = "http://default-url.com";
const WEB_URL = process.env.WEB_URL?.split(",")[20] || DEFAULT_WEB_URL;
...
test.describe("m2d21 E-commerce Test Suite", () => {
  let m2d21: m2d21_Assertions;

  test.beforeEach(async ({ page }) => {
    m2d21 = new m2d21_Assertions(page);
  });
