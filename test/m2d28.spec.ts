...
import { m2d28_Assertions } from "../pages/Assertions/m2d28_Assertions";
import axios from "axios";
import path from "path";

const DEFAULT_WEB_URL = "http://default-url.com";
const WEB_URL = process.env.WEB_URL?.split(",")[27] || DEFAULT_WEB_URL;
...
test.describe("m2d28 E-commerce Test Suite", () => {
  let m2d28: m2d28_Assertions;

  test.beforeEach(async ({ page }) => {
    m2d28 = new m2d28_Assertions(page);
  });
