...
import { m2d14_Assertions } from "../pages/Assertions/m2d14_Assertions";
import axios from "axios";
import path from "path";

const DEFAULT_WEB_URL = "http://default-url.com";
const WEB_URL = process.env.WEB_URL?.split(",")[13] || DEFAULT_WEB_URL;
...
test.describe("m2d14 E-commerce Test Suite", () => {
  let m2d14: m2d14_Assertions;

  test.beforeEach(async ({ page }) => {
    m2d14 = new m2d14_Assertions(page);
  });
