...
import { m2d23_Assertions } from "../pages/Assertions/m2d23_Assertions";
import axios from "axios";
import path from "path";

const DEFAULT_WEB_URL = "http://default-url.com";
const WEB_URL = process.env.WEB_URL?.split(",")[22] || DEFAULT_WEB_URL;
...
test.describe("m2d23 E-commerce Test Suite", () => {
  let m2d23: m2d23_Assertions;

  test.beforeEach(async ({ page }) => {
    m2d23 = new m2d23_Assertions(page);
  });
