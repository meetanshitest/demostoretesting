...
import { m2d6_Assertions } from "../pages/Assertions/m2d6_Assertions";
import axios from "axios";

const DEFAULT_WEB_URL = "http://default-url.com";
const WEB_URL = process.env.WEB_URL?.split(",")[5] || DEFAULT_WEB_URL;
...
test.describe("m2d6 E-commerce Test Suite", () => {
  let m2d6: m2d6_Assertions;

  test.beforeEach(async ({ page }) => {
    m2d6 = new m2d6_Assertions(page);
  });
