...
import { m2d24_Assertions } from "../pages/Assertions/m2d24_Assertions";
import axios from "axios";
import path from "path";

const DEFAULT_WEB_URL = "http://default-url.com";
const WEB_URL = process.env.WEB_URL?.split(",")[23] || DEFAULT_WEB_URL;
...
test.describe("m2d24 E-commerce Test Suite", () => {
  let m2d24: m2d24_Assertions;

  test.beforeEach(async ({ page }) => {
    m2d24 = new m2d24_Assertions(page);
  });
