...
import { m2d17_Assertions } from "../pages/Assertions/m2d17_Assertions";
...
test.describe("m2d17 E-commerce Test Suite", () => {
  ...
  test.beforeEach(async ({ page }) => {
    m2d17 = new m2d17_Assertions(page);
  });
