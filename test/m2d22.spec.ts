...
import { m2d22_Assertions } from "../pages/Assertions/m2d22_Assertions";
import axios from "axios";

const DEFAULT_WEB_URL = "http://default-url.com";
const WEB_URL = process.env.WEB_URL?.split(",")[21] || DEFAULT_WEB_URL;
...
test.describe("m2d22 E-commerce Test Suite", () => {
  let m2d22: m2d22_Assertions;

  test.beforeEach(async ({ page }) => {
    m2d22 = new m2d22_Assertions(page);
  });
