...
import { m2d12_Assertions } from "../pages/Assertions/m2d12_Assertions";
import axios from "axios";
import path from "path";

const DEFAULT_WEB_URL = "http://default-url.com";
const WEB_URL = process.env.WEB_URL?.split(",")[11] || DEFAULT_WEB_URL;
...
test.describe("m2d12 E-commerce Test Suite", () => {
  let m2d12: m2d12_Assertions;

  test.beforeEach(async ({ page }) => {
    m2d12 = new m2d12_Assertions(page);
  });
