...
import { m2d18_Assertions } from "../pages/Assertions/m2d18_Assertions";
import axios from "axios";
import path from "path";

const DEFAULT_WEB_URL = "http://default-url.com";
const WEB_URL = process.env.WEB_URL?.split(",")[17] || DEFAULT_WEB_URL;
...
test.describe("m2d18 E-commerce Test Suite", () => {
  let m2d18: m2d18_Assertions;

  test.beforeEach(async ({ page }) => {
    m2d18 = new m2d18_Assertions(page);
  });
