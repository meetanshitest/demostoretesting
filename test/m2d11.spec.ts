...
import { m2d11_Assertions } from "../pages/Assertions/m2d11_Assertions";
import axios from "axios";
import path from "path";

const DEFAULT_WEB_URL = "http://default-url.com";
const WEB_URL = process.env.WEB_URL?.split(",")[10] || DEFAULT_WEB_URL;
...
test.describe("m2d11 E-commerce Test Suite", () => {
  let m2d11: m2d11_Assertions;

  test.beforeEach(async ({ page }) => {
    m2d11 = new m2d11_Assertions(page);
  });
