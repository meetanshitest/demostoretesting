...
import { m2d15_Assertions } from "../pages/Assertions/m2d15_Assertions";
import axios from "axios";
import path from "path";

const DEFAULT_WEB_URL = "http://default-url.com";
const WEB_URL = process.env.WEB_URL?.split(",")[14] || DEFAULT_WEB_URL;
...
test.describe("m2d15 E-commerce Test Suite", () => {
  let m2d15: m2d15_Assertions;

  test.beforeEach(async ({ page }) => {
    m2d15 = new m2d15_Assertions(page);
  });
