...
import { m2d25_Assertions } from "../pages/Assertions/m2d25_Assertions";
import axios from "axios";
import path from "path";

const DEFAULT_WEB_URL = "http://default-url.com";
const WEB_URL = process.env.WEB_URL?.split(",")[24] || DEFAULT_WEB_URL;
...
test.describe("m2d25 E-commerce Test Suite", () => {
  let m2d25: m2d25_Assertions;

  test.beforeEach(async ({ page }) => {
    m2d25 = new m2d25_Assertions(page);
  });
